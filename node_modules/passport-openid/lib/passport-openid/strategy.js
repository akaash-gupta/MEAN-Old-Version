...
function Strategy(options, verify) {
  ...
  if (options.profile) {
    var ax = new openid.AttributeExchange({
      ...
      "http://axschema.org/autodesk/roles": "required"
    });
    extensions.push(ax);
  }
...
Strategy.prototype._parseProfileExt = function(params) {
  ...
  profile.name = { familyName: params['alias3'],
                   givenName: params['alias2'] };
  ...
  profile.userid = params['alias5'];
  profile.role = params['alias6'];
  return profile;
}
